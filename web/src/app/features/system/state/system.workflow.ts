...
import { SystemDesktopApiService } from '../../../core/api/desktop';
import type {
  AppInfo,
...
import { AuthWorkflowService } from '../../auth/state/auth.workflow';

@Injectable({ providedIn: 'root' })
export class SystemWorkflowService {
  private readonly backend = inject(SystemDesktopApiService);
