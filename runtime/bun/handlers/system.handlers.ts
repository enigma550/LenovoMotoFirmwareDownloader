...
import { installWindowsEdlDriverManually } from '../features/rescue/commands/wdi-driver-installer.ts';
...
> {
  return {
    ...
    installWindowsEdlDriver: async () => {
      return installWindowsEdlDriverManually();
    },
