...
- Windows USB driver helper credit: [pbatard/libwdi](https://github.com/pbatard/libwdi) (`wdi-simple.exe`)
...
| `bun run wdi:prepare` | Build/copy bundled Windows `wdi-simple.exe` tool (Windows targets only) |
...
### Code Style
- Naming convention: variables/parameters use `camelCase`
- Design pattern mapping: `DESIGN_PATTERN_MAP.md`
