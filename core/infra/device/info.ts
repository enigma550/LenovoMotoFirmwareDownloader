...
export async function getDeviceInfo() {
  ...
  return {
    ...
    modelName: environmentVariables.LMSA_MODEL_NAME || (await getFastbootValue('product')),
    modelCode: environmentVariables.LMSA_MODEL_CODE || (await getFastbootValue('sku')),
    sn: environmentVariables.LMSA_SN || (await getFastbootValue('serialno')),
    roCarrier:
      environmentVariables.LMSA_RO_CARRIER || (await getFastbootValue('ro.carrier')) || 'reteu',
  } as DeviceInfo;
}
